...
if ($_GET['tombol']=="Cancel")
   ...
   {
	   $perintah="UPDATE tbl_pegawai SET
	              nrpp='$_POST[nrpp]', nama='$_POST[nama]', kd_cabang='$_POST[kd_cabang]'  WHERE nrpp='$_POST[nrpp]'
				  ";
 ...
 if ($_GET['tombol']=="jadi_delete")
   {
       $perintah="DELETE FROM tbl_pegawai
	              WHERE nrpp='$_GET[id]'";
	     $data =mysqli_query($konek,$perintah);
	   if($data >0)
					{
 ...
 if ($_GET['tombol']=="delete")
   {
       echo "<script type='text/javascript'>
			 ...
			 if (x)
			     window.location.href='pegawai.php?tombol=jadi_delete&id=$_GET[id]';
			 else 
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="pegawai.php"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Tabel Pegawai</a></li>
  </ul>
	</div><!--/.sidebar-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<form action="" method="post">   
                        <div class="table-responsive">
                                <table class="" border ="1">
                                    <tbody>
                                    	...
                                    	<tr><td>Nrpp        </td>
                                    	<td><input placeholder="nrpp" name="nrpp" class="form-control" type="text"></td></tr>
                                            <tr><br><td>Nama    </td>
                                    	<td><input placeholder="nama"  name="nama" class="form-control" type="text">
                                    		</td></tr>
                                         </tr>
                                        <tr><br><td>Kode Kantor    		  </td>
                                    	<td>
                                    	...
                                    	<?php
											...
											while($data=mysqli_fetch_array($hasil)){
											  echo "<option value=$data[kd_kantor]>$data[kd_kantor] - $data[nm_kantor]</option>";
											}
					...
					$simpan ="INSERT INTO `tbl_pegawai` (`nrpp`, `nama`, `kd_cabang`) VALUES ('$nrpp', '$nama', '$kd_cabang');";
                          ...
                          echo '<tr>';
							...
							while($data = mysqli_fetch_array($hasil)){
					  		...
					  		echo "<td class='txt-oflo'>".$i."</td>
					  			  ...
					  			  <td class='txt-oflo'><a class='btn btn-success' href='update_pegawai.php?id=$data[0]'>Edit Data</a></td>
							      <td class='txt-oflo'><a  class='btn btn-success' href='pegawai.php?tombol=delete&id=$data[0]'>
							       Hapus Data</a></td>
                            </tr>";     

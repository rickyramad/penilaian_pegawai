...
?>
 ...
 include "../config.php";
   ...
   {
	   $perintah="UPDATE tbl_unit SET
	              kd_unit='$_POST[kode_unit]', nama_unit='$_POST[nama_unit]'
				  WHERE kd_unit='$_POST[kode_unit]'
				  ";
 ...
 if ($_GET['tombol']=="jadi_delete")
   {
       $perintah="DELETE FROM tbl_unit
	              WHERE kd_unit='$_GET[id]'";
	    $data =mysqli_query($konek,$perintah);
	   if($data >0)
					{
					echo"<script type='text/javascript' language='javascript'>
 ...
 if ($_GET['tombol']=="delete")
   {
       echo "<script type='text/javascript'>
			 ...
			 if (x)
			     window.location.href='unit.php?tombol=jadi_delete&id=$_GET[id]';
			 else 
   ...
   ?>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="unit.php"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Tabel Unit</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<form action="" method="post">   
                        <div class="table-responsive">
                                <table class="" border="1">
                                    <tbody>
                                    	...
                                    	<tr><td>Kode Unit         </td>
                                    	<td><input placeholder="kode unit" onkeypress="return hanyaAngka(event, false)"  name="kd_unit" class="form-control" type="text"></td></tr>
                                         <tr><br><td>Nama Unit    </td>
                                    	<td><input placeholder="unit"  name="nama_unit" class="form-control" type="text"></td></tr>
                                         </tr>
					...
					$simpan ="INSERT INTO `tbl_unit` (`kd_unit`, `nama_unit`) VALUES ('$kd_unit', '$nama_unit');";
                          ...
                          echo '<tr>';
							...
							while($data = mysqli_fetch_array($hasil)){
					  		...
					  		echo "<td class='txt-oflo'>".$i."</td>
					  			  ...
					  			  <td class='txt-oflo'><a class='btn btn-success' href='update_unit.php?id=$data[0]'>Edit Data</a></td>
							      <td class='txt-oflo'><a class='btn btn-success' href='unit.php?tombol=delete&id=$data[0]'>
							       Hapus Data</a></td>
                            </tr>";     

...
?>
 ...
 include "../config.php";
  ...
  if ($_GET['tombol']=="Cancel")
   {
			header('location:perspektif.php');
   }

   if ($_POST['tombol_update']=="Submit")
   {
	   $perintah="UPDATE tbl_perspektif SET
	              kd_perspektif='$_POST[kd_perspektif]', nama_perspektif='$_POST[nama_perspektif]'
				  WHERE kd_perspektif='$_POST[kd_perspektif]'
				  ";
	    ...
	    if($data >0)
					{
			           echo"<script type='text/javascript' language='javascript'>
						...
						window.location.href='perspektif.php';
						</script>";
					}
					else
					{
 ...
 if ($_GET['tombol']=="jadi_delete")
   {
       $perintah="DELETE FROM tbl_perspektif
	              WHERE kd_perspektif='$_GET[id]'";
	  $data =mysqli_query($konek,$perintah);
	   if($data >0)
					{
					echo"<script type='text/javascript' language='javascript'>
 ...
 if ($_GET['tombol']=="delete")
   {
       echo "<script type='text/javascript'>
			 ...
			 if (x)
			     window.location.href='perspektif.php?tombol=jadi_delete&id=$_GET[id]';
			 else 
   ...
   ?>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="perspektif.php"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Tabel Perspektif</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<script language="javascript">
                        ...
                        <div class="table-responsive">
                                <table class="" border="1">
                                    <tbody>
                                    	...
                                    	<tr><td>Kode Perspektif         </td>
                                    	<td><input placeholder="kode perspektif" onkeypress="return hanyaAngka(event, false)"  name="kd_perspektif" class="form-control" type="text"></td></tr>
                                         <tr><br><td>Nama Perspektif    </td>
                                    	<td><input placeholder="nama perspektif"  name="nama_perspektif" class="form-control" type="text"></td></tr>
                                         </tr>
					...
					$kd	= $_POST['simpan'];
					$kd_perspektif	= $_POST['kd_perspektif'];
					$nama_perspektif	= $_POST['nama_perspektif'];
					$simpan ="INSERT INTO `tbl_perspektif` (`kd_perspektif`, `nama_perspektif`) VALUES ('$kd_perspektif', '$nama_perspektif');";
                          ...
                          echo '<tr>';
							...
							while($data = mysqli_fetch_array($hasil)){
					  		...
					  		echo "<td class='txt-oflo'>".$i."</td>
					  			  ...
					  			  <td class='txt-oflo'><a class='btn btn-success' href='update_pers.php?id=$data[0]'>Edit Data</a></td>
							      <td class='txt-oflo'><a class='btn btn-success' href='perspektif.php?tombol=delete&id=$data[0]'>
							       Hapus Data</a></td>
                            </tr>";     
